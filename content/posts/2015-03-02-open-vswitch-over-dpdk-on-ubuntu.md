...
To bind an "active" NIC (one that is being used by Linux already) you will need to force it: <span class="anchor" id="line-148"></span><span class="anchor" id="line-149"></span>
