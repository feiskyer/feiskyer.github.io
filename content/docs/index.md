...
* [京东容器建设之路](jd-container/)
* [Network namespace](networking-namespace/)

## 虚拟化

* [GPU虚拟化](/virtualization/GPU/)
* [SR-IOV](/virtualization/SR-IOV/)
* [VFIO](http://awilliam.github.io/presentations/KVM-Forum-2016/)

## 分布式系统

* [分布式系统简介](http://feisky.xyz/distributed/)
* [Paxos](http://feisky.xyz/distributed/paxos/)
* [Raft](http://feisky.xyz/distributed/raft/)
* [Zab](http://feisky.xyz/distributed/zab/)
...
- [数据可视化](http://feisky.xyz/machine-learning/visualization/)
...
- [Amazon Leadership Principles](amazon-leadership/)
- [架构即未来](架构即未来/)
